const contentLetterSrart_actived = "HAPPY BIRTH DAY." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc cậu sinh nhật vui vẽ nhá, thành công trong công việc và học tập nha." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "tải_xuống-removebg-preview.png";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "tải_xuống-removebg-preview.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
